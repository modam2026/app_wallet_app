...
class PageMyCfgList extends StatefulWidget {
  const PageMyCfgList({Key? key}) : super(key: key);

  @override
  State<PageMyCfgList> createState() => _PageMyUserBankState();
}

class _PageMyUserBankState extends State<PageMyCfgList> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(title: Text("사용앱 리스트(2/7)")),
