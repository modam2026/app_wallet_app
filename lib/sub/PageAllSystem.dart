...
class PageAllSystem extends StatefulWidget {
  const PageAllSystem({Key? key}) : super(key: key);

  @override
  State<PageAllSystem> createState() => _PageAllSystemState();
}

class _PageAllSystemState extends State<PageAllSystem> {
    ...
    return MaterialApp(
      home: Scaffold(
        ...
        body: FutureBuilder<List<CachedApplication>>(
          future: commonHelper
              .getListCachedApplication(commonHelper.appDataWithSys),
