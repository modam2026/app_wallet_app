...
class PageMyUserInstSys extends StatefulWidget {
  const PageMyUserInstSys({Key? key}) : super(key: key);

  @override
  State<PageMyUserInstSys> createState() => _PageMyUserInstSysState();
}

class _PageMyUserInstSysState extends State<PageMyUserInstSys> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(title: Text("구글&폰앱 리스트(3/6)")),
